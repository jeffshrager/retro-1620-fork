...
HOW TO RUN (browser emulator or CLI): load these four card decks, in order
  ...
  Use the Mod-3-4 interpreter decks, not the originals.  The original decks
  fail on every printed data term (Punch Check "??+", then an arithmetic check).
  The Subroutines deck supplies the loaded IPL-V library routines (J10, J11,
  J16, J120, J125, J126, J129, J200 ...) that the program calls.
